...
class _DateTimeNotificationWidgetState extends State<DateTimeNotificationWidget> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (!addTaskProvider.isRoutine) _buildCalendarSection() else _buildSelectDaysSection(),
  ...
  Widget _buildDayButton(int index, String name) {
    final isSelected = addTaskProvider.selectedDays.contains(index);
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: () {
          ...
          // Tarihsiz seçiliyken rutin günü seçilmeye çalışıldığında uyarı
          if (addTaskProvider.selectedDate == null && !addTaskProvider.selectedDays.contains(index)) {
            Helper().getMessage(
              message: LocaleKeys.RoutineMustHaveDate.tr(),
              status: StatusEnum.WARNING,
            );
          ...
          if (addTaskProvider.selectedDays.contains(index)) {
            addTaskProvider.selectedDays.remove(index);
          } else {
            addTaskProvider.selectedDays.add(index);
          }
