        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              // Status chips with colors and icons (excluding ARCHIVED and CANCEL)
              ...TaskStatusEnum.values.where((status) => status != TaskStatusEnum.ARCHIVED && status != TaskStatusEnum.CANCEL).map((status) {
