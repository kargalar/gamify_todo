...
class _QuickAddTaskBottomSheetState extends State<QuickAddTaskBottomSheet> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      LogService.debug('🎯 QuickAddTaskBottomSheet: Focused on task name field');
    });
  }
  ...
  Future<void> _addTask() async {
    ...
    try {
      ...
      if (mounted) {
        LogService.debug(
          '✅ QuickAddTaskBottomSheet: Task added successfully - "${taskModel.title}"',
        );
      ...
      builder: (context, provider, _) {
        return PopScope(
          ...
          onPopInvokedWithResult: (_, __) {
            LogService.debug('📋 QuickAddTaskBottomSheet closed, resetting form');
            provider.reset();
          },
          child: Container(
